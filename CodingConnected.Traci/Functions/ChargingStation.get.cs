...
public partial class ChargingStation
    ...
    /// <summary>
    /// GetVariable the total number of vehicles stopped at the named charging station.
    /// </summary>
    /// <param name="stopId"></param>
    /// <returns></returns>
    /// <remarks>
    ...
    /// <summary>
    /// 	GetVariable the IDs of vehicles stopped at the named charging station.
    /// </summary>
    /// <param name="stopId"></param>
    /// <returns></returns>
    /// <remarks>
    ...
    /// <summary>
    /// GetVariable the IDs of vehicles stopped at the named charging station.The charging power in W
    /// </summary>
    /// <param name="stopId"></param>
    /// <returns></returns>
    /// <remarks>
