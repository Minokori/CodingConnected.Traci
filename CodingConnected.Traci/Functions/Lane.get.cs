...
public partial class Lane
    ...
    /// </remarks>
    public int GetLinkNumber(string laneId)
        {
        var result = Helper.ExecuteGetCommand(
            GetVariable.Lane,
    ...
    public IList<Link> GetLinks(string laneId)
        ...
        var result = (TraciCompoundObject)
            Helper.ExecuteGetCommand(GetVariable.Lane, TraciConstants.LANE_LINKS, laneId).Data;
    ...
    public List<(double x, double y)> GetShape(string laneId)
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Lane, TraciConstants.VAR_SHAPE, laneId);
    ...
    public double GetWidth(string laneId)
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Lane, TraciConstants.VAR_WIDTH, laneId);
        return (TraciDouble)result.Data;
        }
    ...
    public int GetLastStepVehicleNumber(string laneId)
        ...
        var result = Helper.ExecuteGetCommand(
            GetVariable.Lane,
            TraciConstants.LastStepVehicleNumber,
            laneId
        );
        return (TraciInteger)result.Data;
        }
    ...
    public double GetLastStepMeanSpeed(string laneId)
        ...
        var result = Helper.ExecuteGetCommand(
            GetVariable.Lane,
            TraciConstants.LastStepMeanSpeed,
            laneId
        );
        return (TraciDouble)result.Data;
        }
