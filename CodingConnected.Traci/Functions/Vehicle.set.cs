...
public partial class Vehicle
    ...
    public bool SetStop(
        ...
        byte laneIndex = 0,
        double duration = TraciConstants.InvalidDoubleValue,
        StopFlag flags = StopFlag.Default,
        double startPosition = TraciConstants.InvalidDoubleValue,
        double until = TraciConstants.InvalidDoubleValue
    )
        {
    ...
    public bool SetContainerStop(
        ...
        SetStop(
            ...
            duration: duration,
            until: until,
            flags: flags | StopFlag.ContainerStop
        );
    ...
    public bool SetChargingStationStop(
        ...
        SetStop(
            ...
            duration: duration,
            until: until,
            flags: flags | StopFlag.ChargingStation
        );
    ...
    public bool SetParkingAreaStop(
        ...
        SetStop(
            ...
            duration: duration,
            until: until,
            flags: flags | StopFlag.ParkingArea
        );
    ...
    public bool ChangeTarget(string vehicleId, string destinationEdgeId)
        ...
        return Helper.ExecuteSetCommand(
            Setter.Vehicle,
            CommandIdentifier.ChangeTarget,
            vehicleId,
            tmp
        );
        }
    ...
    public bool SetPreviousSpeed(
        string vehicleId,
        double speed,
        double acceleration = TraciConstants.InvalidDoubleValue
    )
        {
        var tmp = new TraciCompoundObject()
        {
    ...
    /// <summary>
    /// Assigns the list of edgeList as the vehicle's new route assuming the first edge given is the one the vehicle is currently at
    /// </summary>
    /// <param name="vehicleId"></param>
    ...
    /// </remarks>
    public bool SetAdaptedTravelTime(
        string vehicleId,
        string edgeId,
        double? time = null,
    ...
    /// <summary>
    /// Sets a new state of signals. See TraCI/Vehicle Signaling <see href="https://sumo.dlr.de/docs/TraCI/Vehicle_Signalling.html"/> for more information.
    /// </summary>
    /// <param name="vehicleId"></param>
    ...
    public bool MoveTo(
        ...
        string laneId,
        double position,
        MoveReason reason = MoveReason.MoveAutomatic
    )
        {
        TraciCompoundObject tmp =
        [
            new TraciString(laneId),
            new TraciDouble(position),
            new TraciInteger((int)reason),
        ];
        return Helper.ExecuteSetCommand(
            Setter.Vehicle,
    ...
    public bool MoveToXY(
        ...
        double xPosition,
        double yPosition,
        double angle = TraciConstants.InvalidDoubleValue,
        int keepRoute = 1,
        ...
        return Helper.ExecuteSetCommand(Setter.Vehicle, TraciConstants.MOVE_TO_XY, id, tmp);
        }
    ...
    public bool RerouteTravelTime(string vehicleId, bool currentTravelTimes = true)
        ...
        TraciCompoundObject tmp = [];
        var result = Helper.ExecuteSetCommand(
            Setter.Vehicle,
            CommandIdentifier.RerouteTravelTime,
            vehicleId,
            tmp
        );
        if (currentTravelTimes && routingMode == (int)RoutingMode.Default)
    ...
    public bool RerouteEffort(string vehicleId)
        ...
        return Helper.ExecuteSetCommand(
            Setter.Vehicle,
            CommandIdentifier.RerouteEffort,
            vehicleId,
            tmp
        );
        }
    ...
    public bool SetLaneChangeMode(
        string id,
        LaneChangeStrategicMode strategic,
    ...
    public bool Highlight(
        ...
        if (type > 255)
            throw new ArgumentOutOfRangeException(
                nameof(type),
                "vehicle.highlight(): maximal value for type is 255"
            );
        if (alphaMax > 255)
            throw new ArgumentOutOfRangeException(
                nameof(alphaMax),
                "vehicle.highlight(): maximal value for alphaMax is 255"
            );
        if (alphaMax < 0 && duration > 0)
            throw new ArgumentOutOfRangeException(
                nameof(alphaMax),
                "vehicle.highlight(): duration>0 requires alphaMax>0"
            );
        if (alphaMax > 0 && duration < 0)
            throw new ArgumentOutOfRangeException(
                nameof(duration),
                "vehicle.highlight(): alphaMax>0 requires duration>0"
            );
