...
public partial class Simulation
    ...
    public double GetDeltaT()
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Simulation, TraciConstants.VAR_DELTA_T);
        return (TraciDouble)result.Data;
        }
    ...
    public double GetScale()
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Simulation, TraciConstants.VAR_SCALE);
        return (TraciDouble)result.Data;
        }
    ...
    public Tuple<double, double> Convert2D(
        ...
        {
        var positionType = toGeo ? DataType.LonLat : DataType.XY;
    ...
    public Tuple<double, double, double> Convert3D(
        ...
        {
        var positionType = toGeo ? DataType.LonLatAlt : DataType.XYZ;
        var tmp = new TraciCompoundObject()
        {
            new RoadMapPosition(edgeId, position, laneIndex),
            new TraciUnsignedByte((byte)positionType),
    ...
    public Tuple<double, double> ConvertGeo(double x, double y, bool fromGeo = false)
        ...
        switch (fromGeo)
            ...
            case true:
                {
                positionType = DataType.XY;
                position = new LonLatPosition(x, y);
                break;
                }
            case false:
                {
                positionType = DataType.LonLat;
    ...
    public double GetDistanceRoad(
        ...
        {
        var distanceType = isDriving ? DistanceType.DrivingDistance : DistanceType.AirDistance;
    ...
    public Stage FindIntermodalRoute(
        ...
        double arrivalPos = TraciConstants.InvalidDoubleValue,
    ...
    public List<Collision> GetCollisions()
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Simulation, TraciConstants.VAR_COLLISIONS);
