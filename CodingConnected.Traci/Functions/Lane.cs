...
/// </list>
/// </remarks>
public partial class Lane(ISumoConnectService tcpService, ITraciCommandService helper, ILogger logger) : TraciContextSubscribeCommands(tcpService, helper, logger)
    {
