...
public partial class Junction
    ...
    public List<string> GetIdList()
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Junction, TraciConstants.IdList, "");
    ...
    public int GetIdCount()
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Junction, TraciConstants.IdCount, "");
    ...
    public List<(double x, double y)> GetShape(string junctionId)
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Junction, TraciConstants.VAR_SHAPE, junctionId);
    ...
    public List<string> GetIncomingEdges(string junctionId)
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Junction, TraciConstants.INCOMING_EDGES, junctionId);
        return (TraciStringList)result.Data;
        }
    ...
    public List<string> GetOutgoingEdges(string junctionId)
        {
        var result = Helper.ExecuteGetCommand(GetVariable.Junction, TraciConstants.OUTGOING_EDGES, junctionId);
        return (TraciStringList)result.Data;
        }
    }
