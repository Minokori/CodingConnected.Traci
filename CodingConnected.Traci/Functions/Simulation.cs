...
public partial class Simulation(ISumoConnectService tcpService, ITraciCommandService helper) : FunctionBase(tcpService, helper)
    ...
    /// </remarks>
    public override void Subscribe(string objectId, int beginTime, int endTime, List<byte> VariablesToSubscribeTo) => Helper.ExecuteSubscribeCommand(beginTime, endTime, (byte)CommandIdentifier.Subscribe.SimulationVariable, VariablesToSubscribeTo, "");
    }
