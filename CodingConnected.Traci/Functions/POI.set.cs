...
public partial class POI
    ...
    public bool SetType(string poiId, string poiType)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.VAR_TYPE, poiId, tmp);
        }
    ...
    public bool SetColor(string poiId, int r, int g, int b, int a = 255)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.VAR_COLOR, poiId, color);
        }
    ...
    public bool SetWidth(string poiId, double width)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.VAR_WIDTH, poiId, tmp);
        }
    ...
    public bool SetHeight(string poiId, double height)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.VAR_HEIGHT, poiId, tmp);
        }
    ...
    public bool SetAngle(string poiId, double angle)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.VAR_ANGLE, poiId, tmp);
        }
    ...
    public bool Add(
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.ADD, poiId, tmp);
        }
    ...
    public bool Remove(string poiId, int layer = 0)
        ...
        return Helper.ExecuteSetCommand(Setter.Poi, TraciConstants.REMOVE, poiId, tmp);
        }
