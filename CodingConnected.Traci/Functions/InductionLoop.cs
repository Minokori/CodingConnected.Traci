...
public partial class InductionLoop(ISumoConnectService sumoConnectService, ITraciCommandService traciCommandService) : TraciContextSubscribeCommands(sumoConnectService, traciCommandService)
    ...
    /// </remarks>
    public void Subscribe(string loopId, double beginTime, double endTime, List<byte> ListOfVariablesToSubsribeTo) => Helper.ExecuteSubscribeCommand(
            beginTime,
            endTime,
            (byte)CommandIdentifier.Subscribe.InductionLoopVariable,
