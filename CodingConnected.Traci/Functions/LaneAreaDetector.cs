...
/// </list>
/// </remarks>
public partial class LaneAreaDetector(ISumoConnectService tcpService, ITraciCommandService helper, ILogger logger) : FunctionBase(tcpService, helper, logger)
    {
    /// <summary>
    ...
    /// </remarks>
    public override void Subscribe(string objectId, int beginTime, int endTime, List<byte> VariablesToSubscribeTo) => Helper.ExecuteSubscribeCommand(beginTime, endTime, (byte)CommandIdentifier.Subscribe.LaneAreaVariable, VariablesToSubscribeTo, objectId);
    }
