...
public partial class Simulation
    ...
    public bool ClearPending(string routeId = "")
        ...
        return Helper.ExecuteSetCommand(Setter.Simulation, ClearPendingVehicles, "", tmp);
        }
    ...
    public bool SaveState(string fileName)
        ...
        return Helper.ExecuteSetCommand(Setter.Simulation, SaveSimulationState, "", tmp);
        }
    ...
    public bool LoadState(string fileName)
        {
        TraciString tmp = new(fileName);
        return Helper.ExecuteSetCommand(Setter.Simulation, LoadSimulationState, "", tmp);
        }

    /// <summary>
    /// 	Setter traffic scaling factor
    /// </summary>
    ...
    public bool SetScale(double value)
        ...
        return Helper.ExecuteSetCommand(Setter.Simulation, TraciConstants.VAR_SCALE, "", tmp);
        }
    }
