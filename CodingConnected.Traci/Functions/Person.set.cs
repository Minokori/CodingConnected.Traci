...
public partial class Person
    ...
    public bool Add(
        ...
        return Helper.ExecuteSetCommand(Setter.Person, TraciConstants.ADD, personId, tmp);
        }
    ...
    /// </remarks>
    public bool Remove(string personId, RemoveReason reason = RemoveReason.Varporized) =>
        Helper.ExecuteSetCommand(
            Setter.Person,
