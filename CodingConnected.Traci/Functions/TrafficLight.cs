...
/// <summary>
/// traffic light state related Commands
/// </summary>
...
/// </item>
/// <item>
/// get-commands part see <see href="https://sumo.dlr.de/docs/TraCI/Traffic_Lights_Value_Retrieval.html"/>
/// </item>
/// <item>
///  set-commands part see <see href="https://sumo.dlr.de/docs/TraCI/Change_Traffic_Lights_State.html"/>
/// </item>
/// </list>
/// </remarks>
public partial class TrafficLight(ISumoConnectService tcpService, ITraciCommandService helper, ILogger logger) : FunctionBase(tcpService, helper, logger)
    {

    /// <summary>
    /// subscribe to a list of variables of a vehicle type
    /// </summary>
    /// <param name="objectId">vehicle type ID</param>
    ...
    /// </remarks>
    public override void Subscribe(string objectId, int beginTime, int endTime, List<byte> VariablesToSubscribeTo) => Helper.ExecuteSubscribeCommand(beginTime, endTime, (byte)CommandIdentifier.Subscribe.TrafficLightsVariable, VariablesToSubscribeTo, objectId);
    }
