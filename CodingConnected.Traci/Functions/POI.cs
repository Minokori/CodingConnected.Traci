...
/// </item>
/// <item>
/// get-commands part see <see href="https://sumo.dlr.de/docs/TraCI/POI_Value_Retrieval.html"/>
/// </item>
/// <item>
///  set-commands part see <see href="https://sumo.dlr.de/docs/TraCI/Change_PoI_State.html"/>
/// </item>
/// </list>
/// </remarks>
public partial class POI(ISumoConnectService tcpService, ITraciCommandService helper) : TraciContextSubscribeCommands(tcpService, helper)
    ...
    /// </summary>
    /// <param name="poiId">vehicle type ID</param>
    ...
    /// </remarks>
    public void Subscribe(string poiId, double beginTime, double endTime, List<byte> ListOfVariablesToSubsribeTo) => Helper.ExecuteSubscribeCommand(beginTime, endTime, (byte)CommandIdentifier.Subscribe.PoiVariable, ListOfVariablesToSubsribeTo, poiId);
    }
