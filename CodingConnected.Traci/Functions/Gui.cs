...
public partial class Gui(ISumoConnectService tcpService, ITraciCommandService helper, ILogger logger) : FunctionBase(tcpService, helper, logger)
    ...
    /// </summary>
    /// <param name="objectId">view ID</param>
    ...
    /// </remarks>
    public override void Subscribe(string objectId, int beginTime, int endTime, List<byte> VariablesToSubscribeTo) => Helper.ExecuteSubscribeCommand(beginTime, endTime, (byte)CommandIdentifier.Subscribe.GuiVariable, VariablesToSubscribeTo, objectId);
    }
