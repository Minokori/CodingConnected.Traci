namespace CodingConnected.Traci.NewDataTypes.Base;
...
public interface ITraciBaseType<T> : ITraciType
    {
    new virtual DataType TypeIdentifier =>
    ...
    static (ITraciBaseType<T> traciData, IEnumerable<byte> remainingBytes) FromBytes(
    ...
    public static virtual implicit operator T(ITraciBaseType<T> traciData) => traciData.Value;
