...
public static partial class RouteTest
    {
    public static void TestRoute(this TraciClient client)
        {
        Console.WriteLine();
        Console.WriteLine("Route Test");
        var boolMethods = typeof(RouteTest).GetMethods(BindingFlags.NonPublic | BindingFlags.Static);
