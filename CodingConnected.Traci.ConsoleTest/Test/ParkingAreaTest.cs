...
internal static partial class ParkingAreaTest
    {
    public static void TestParkingArea(this TraciClient client)
        {
        Console.WriteLine();
        Console.WriteLine("ParkingArea Test");
        var boolMethods = typeof(ParkingAreaTest).GetMethods(BindingFlags.NonPublic | BindingFlags.Static);
