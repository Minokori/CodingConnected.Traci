...
internal static partial class VehicleTypeTest
    {

    public static void TestVehicleType(this TraciClient client)
        {
        Console.WriteLine();
        Console.WriteLine("VehicleType Test");
        var boolMethods = typeof(VehicleTypeTest).GetMethods(BindingFlags.NonPublic | BindingFlags.Static);
