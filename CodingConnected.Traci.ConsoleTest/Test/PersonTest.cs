...
internal static partial class PersonTest
    {
    public static void TestPerson(this TraciClient client)
        {
        Console.WriteLine();
        Console.WriteLine("Person Test");
        var boolMethods = typeof(PersonTest).GetMethods(BindingFlags.NonPublic | BindingFlags.Static);
