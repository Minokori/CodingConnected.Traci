...
internal static partial class TrafficLightTest
    {

    public static void TestTrafficLight(this TraciClient client)
        {
        Console.WriteLine();
        Console.WriteLine("TrafficLight Test");
        var boolMethods = typeof(TrafficLightTest).GetMethods(BindingFlags.NonPublic | BindingFlags.Static);
