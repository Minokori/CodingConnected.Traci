...
/// </list>
/// </remarks>
public partial class TrafficLight(ITCPConnectService tcpService, ICommandService helper) : FunctionBase(tcpService, helper)
    {

    /// <summary>
    /// subscribe to a list of variables of a vehicle type
    /// </summary>
    /// <param name="tlsId">vehicle type ID</param>
    ...
    /// </remarks>
    public void Subscribe(string tlsId, int beginTime, int endTime, List<byte> ListOfVariablesToSubsribeTo)
        {
        _helper.ExecuteSubscribeCommand(beginTime, endTime, tlsId, TraCIConstants.CMD_SUBSCRIBE_TL_VARIABLE, ListOfVariablesToSubsribeTo);
        }
    }
