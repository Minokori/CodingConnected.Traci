...
public class PolygonCommands(ITCPConnectService tcpService, ICommandService helper) : TraCIContextSubscribableCommands(tcpService, helper)
    {
    ...
    public string GetType(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_POLYGON_VARIABLE, TraCIConstants.VAR_TYPE, id);
    ...
    public Color GetColor(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_POLYGON_VARIABLE, TraCIConstants.VAR_COLOR, id);
    ...
    public Polygon GetShape(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_POLYGON_VARIABLE, TraCIConstants.VAR_SHAPE, id);
    ...
    public bool GetFilled(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_POLYGON_VARIABLE, TraCIConstants.VAR_FILL, id);
