...
public class VehicleTypeCommands(ITCPConnectService tcpService, ICommandService helper) : TraCICommandsBase(tcpService, helper)
    {
    ...
    public double GetLength(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_LENGTH, id);
    ...
    public double GetMaxSpeed(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_MAXSPEED, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetAccel(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_ACCEL, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetDecel(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_DECEL, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetTau(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_TAU, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetImperfection(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_IMPERFECTION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetSpeedFactor(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_SPEED_FACTOR, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public string GetVehicleClass(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_VEHICLECLASS, id);
    ...
    public string GetEmissionClass(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_EMISSIONCLASS, id);
        return ((TraCIString)result.Value).Value;
        }
    ...
    public string GetShapeClass(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_SHAPECLASS, id);
        return ((TraCIString)result.Value).Value;
        }
    ...
    public double GetMinGap(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_MINGAP, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetWidth(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_WIDTH, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetHeight(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_HEIGHT, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public Color GetColor(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_COLOR, id);
    ...
    public double GetMaxSpeedLat(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_MAXSPEED_LAT, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetMinGapLat(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_MINGAP_LAT, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public string GetLateralAlignment(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_VEHICLETYPE_VARIABLE, TraCIConstants.VAR_LATALIGNMENT, id);
        return ((TraCIString)result.Value).Value;
        }
...
id);
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public bool SetActionStepLengt(string id)
        {
