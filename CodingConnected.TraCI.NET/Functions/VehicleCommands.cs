...
public class VehicleCommands(ITCPConnectService tcpService, ICommandService helper) : TraCIContextSubscribableCommands(tcpService, helper)
    {
...
id);
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public bool SetParamater(string id)
        {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public bool SetActionStepLength(string id)
        {
        throw new NotImplementedException();
        }
