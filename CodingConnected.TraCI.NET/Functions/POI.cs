...
public partial class POI(ITCPConnectService tcpService, ICommandService helper) : TraCIContextSubscribableCommands(tcpService, helper)
    ...
    /// </remarks>
    public void Subscribe(string poiId, double beginTime, double endTime, List<byte> ListOfVariablesToSubsribeTo)
        {
        _helper.ExecuteSubscribeCommand(beginTime, endTime, poiId, TraCIConstants.CMD_SUBSCRIBE_POI_VARIABLE, ListOfVariablesToSubsribeTo);
        }
    }
