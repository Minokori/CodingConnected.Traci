...
public class LaneCommands(ITCPConnectService tcpService, ICommandService helper) : TraCIContextSubscribableCommands(tcpService, helper)
    {
    ...
    public byte GetLinkNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LANE_LINK_NUMBER, id);
    ...
    public string GetEdgeId(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LANE_EDGE_ID, id);
    ...
    public TraCICompoundObject GetLinks(string id)
        ...
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LANE_LINKS, id);
    ...
    public List<string> GetAllowed(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LANE_ALLOWED, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public List<string> GetDisallowed(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LANE_DISALLOWED, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public double GetLength(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_LENGTH, id);
    ...
    public double GetMaxSpeed(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_MAXSPEED, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public Polygon GetShape(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_SHAPE, id);
    ...
    public double GetWidth(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_WIDTH, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetCO2Emission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_CO2EMISSION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetCOEmission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_COEMISSION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetHCEmission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_HCEMISSION, id);
        return ((TraCIDouble)result.Value).Value;
    ...
    public double GetPMxEmission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_PMXEMISSION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetNOxEmission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_NOXEMISSION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetFuelConsumption(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_FUELCONSUMPTION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetNoiseEmission(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_NOISEEMISSION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetElectricityConsumption(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_ELECTRICITYCONSUMPTION, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public int GetLastStepVehicleNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_VEHICLE_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public double GetLastStepMeanSpeed(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_MEAN_SPEED, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public List<string> GetLastStepVehicleIds(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_VEHICLE_ID_LIST, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public double GetLastStepOccupancy(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_OCCUPANCY, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetLastStepLength(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_LENGTH, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetWaitingTime(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_WAITING_TIME, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetTravelTime(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.VAR_CURRENT_TRAVELTIME, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public int GetLastStepHaltingNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_LANE_VARIABLE, TraCIConstants.LAST_STEP_VEHICLE_HALTING_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
