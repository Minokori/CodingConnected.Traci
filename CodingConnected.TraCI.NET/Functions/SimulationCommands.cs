...
public class SimulationCommands(ITCPConnectService tcpService, ICommandService helper) : FunctionBase(tcpService, helper)
    ...
    public int GetCurrentTime(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TIME_STEP, id);
    ...
    public double GetTime(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TIME, id);
    ...
    public int GetLoadedNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_LOADED_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetLoadedIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_LOADED_VEHICLES_IDS, id);
    ...
    public int GetDepartedNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_DEPARTED_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetDepartedIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_DEPARTED_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetStartingTeleportNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TELEPORT_STARTING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetStartingTeleportIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TELEPORT_STARTING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetEndingTeleportNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TELEPORT_ENDING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetEndingTeleportIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_TELEPORT_ENDING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetArrivedNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_ARRIVED_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetArrivedIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_ARRIVED_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public Polygon GetNetBoundary(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_NET_BOUNDING_BOX, id);
    ...
    public int GetMinExpectedNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_MIN_EXPECTED_VEHICLES, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public int GetStopStartingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_STOP_STARTING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetStopStartingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_STOP_STARTING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetStopEndingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_STOP_ENDING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetStopEndingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_STOP_ENDING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetCollidingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_COLLIDING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetCollidingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_COLLIDING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetEmergencyStoppingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_EMERGENCYSTOPPING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetEmergencyStoppingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_EMERGENCYSTOPPING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetParkingStartingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_PARKING_STARTING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetParkingStartingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_PARKING_STARTING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetParkingEndingVehiclesNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_PARKING_ENDING_VEHICLES_NUMBER, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public List<string> GetParkingEndingVehiclesIDList(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_PARKING_ENDING_VEHICLES_IDS, id);
        return ((TraCIStringList)result.Value).Value;
        }
    ...
    public int GetBusStopWaiting(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_BUS_STOP_WAITING, id);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public double GetDeltaT(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_DELTA_T, id);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public string GetParameter(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_SIM_VARIABLE, TraCIConstants.VAR_PARAMETER, id);
