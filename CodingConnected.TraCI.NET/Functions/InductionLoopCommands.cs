...
public class InductionLoopCommands(ITCPConnectService tcpService, ICommandService helper) : TraCIContextSubscribableCommands(tcpService, helper)
    {
    ...
    public double GetPosition(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.VAR_POSITION, id);
    ...
    public string GetLaneId(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.VAR_LANE_ID, id);
    ...
    public int GetLastStepVehicleNumber(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.LAST_STEP_VEHICLE_NUMBER, id);
        return ((TraCIInteger)result).Value;
        }
    ...
    public List<string> GetLastStepVehicleIds(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.LAST_STEP_VEHICLE_ID_LIST, id);
        return ((TraCIStringList)result).Value;
        }
    ...
    public double GetLastStepOccupancy(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.LAST_STEP_OCCUPANCY, id);
        return ((TraCIDouble)result).Value;
        }
    ...
    public double GetLastStepMeanLength(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.LAST_STEP_LENGTH, id);
        return ((TraCIDouble)result).Value;
        }
    ...
    public double GetTimeSinceDetection(string id)
        {
        var result = _helper.ExecuteGetCommand(TraCIConstants.CMD_GET_INDUCTIONLOOP_VARIABLE, TraCIConstants.LAST_STEP_TIME_SINCE_DETECTION, id);
        return ((TraCIDouble)result).Value;
        }
