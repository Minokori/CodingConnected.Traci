...
public class PersonCommands(ITcpService tcpService, ICommandHelperService helper) : TraCICommandsBase(tcpService, helper)
    {
    ...
    public List<string> GetIdList()
        {
        var result = _helper.ExecuteGetCommand("ignored", TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.ID_LIST);
    ...
    public int GetIdCount()
        {
        var result = _helper.ExecuteGetCommand("ignored", TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.ID_COUNT);
    ...
    public double GetSpeed(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_SPEED);
    ...
    public Position2D GetPosition(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_POSITION);
    ...
    public Position3D GetPosition3D(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_POSITION3D);
    ...
    public double GetAngle(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_ANGLE);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public string GetRoadID(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_ROAD_ID);
    ...
    public string GetTypeID(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_TYPE);
        return ((TraCIString)result.Value).Value;
        }
    ...
    public Color GetColor(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_COLOR);
    ...
    public double GetLanePosition(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_LANEPOSITION);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetLength(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_LENGTH);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetMinGap(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_MINGAP);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetWidth(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_WIDTH);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public double GetWaitingTime(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_WAITING_TIME);
        return ((TraCIDouble)result.Value).Value;
        }
    ...
    public string GetNextEdge(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_NEXT_EDGE);
        return ((TraCIString)result.Value).Value;
        }
    ...
    public int GetRemainingStages(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_STAGES_REMAINING);
        return ((TraCIInteger)result.Value).Value;
        }
    ...
    public string GetVehicle(string id)
        {
        var result = _helper.ExecuteGetCommand(id, TraCIConstants.CMD_GET_PERSON_VARIABLE, TraCIConstants.VAR_VEHICLE);
        return ((TraCIString)result.Value).Value;
        }
